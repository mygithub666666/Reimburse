...
import reimburse.cuc.com.adaptor.ItemWaitSelectAdapter;
 ...
 */
public class ActivityWaitSelected extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        databaseHelper = new DatabaseHelper(ActivityWaitSelected.this);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ActivityWaitSelected.this,tvExpenseTotal.getText().toString(),Toast.LENGTH_LONG).show();
    ...
    public void showData(){
         ...
         if(allConsumptions != null){
               expenseSubmitAdapter = new ExpenseSubmitAdapter(ActivityWaitSelected.this,allConsumptions,tvExpenseTotal,checkboxAll);
              ...
              recyclerview.setLayoutManager(new LinearLayoutManager(ActivityWaitSelected.this, LinearLayoutManager.VERTICAL,false));
