 ...
 */
public class ExpenseSubmitAdapterBackuup extends RecyclerView.Adapter<ExpenseSubmitAdapterBackuup.ViewHolder> {
    private CheckBox checkboxAll;
    private TextView tvExpenseTotal;
    private Context context;
    private List<Consumption> consumptions;

    public ExpenseSubmitAdapterBackuup() {
    }

    public ExpenseSubmitAdapterBackuup(Context context, List<Consumption> allConsumptions, TextView tvExpenseTotal, CheckBox checkboxAll) {
    ...
    public ExpenseSubmitAdapterBackuup(Context context, List<Consumption> consumptions) {
        this.context = context;
